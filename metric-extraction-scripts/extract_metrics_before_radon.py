...
cc_data  = rodar_radon(["radon", "cc",  "./cleanlab", "-j"])
print("Rodando radon mi...")
mi_data  = rodar_radon(["radon", "mi",  "./cleanlab", "-j"])
print("Rodando radon hal...")
hal_data = rodar_radon(["radon", "hal", "./cleanlab", "-j"])
print("Rodando radon raw...")
raw_data = rodar_radon(["radon", "raw", "./cleanlab", "-j"])
